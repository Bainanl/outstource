<template>
    <div class="flex-row">
            ...
            <el-form :model="form" label-width="150px" size="large">
                <el-form-item label="文创类型">
                    <el-select v-model="form.region" placeholder="please select your zone">
                        <el-option label="服饰" value="shanghai" />
                        <el-option label="手绢" value="beijing" />
                    </el-select>
                </el-form-item>
                <el-form-item label="选择纹样">
                    <el-select v-model="form.wenyang" placeholder="please select your zone">
                        <el-option :label="item.name" value="shanghai" v-for="item in form.img" />
                    </el-select>
                </el-form-item>
                <el-form-item label="定制字样">
                    <el-input v-model="form.ziyang" />
                </el-form-item>
        ...
        <div class="www flex-col  items-center">
            <span class="xxx">我们将在定制完成后的一个工作日内使用快递寄出，您将会受到您亲手定制的文创产品！</span>
            <el-button style="width: 20vw;" size="large" color="#4169e1">确认定制</el-button>
        </div>
    </div>
</template>
